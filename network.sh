...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    peer_cert peer peer0.org1.aria.com.np org1
    peer_cert admin Admin@org1.aria.com.np org1

    infoln "Creating Org2 Identities"
    #function_name cert-type   CN   org
    peer_cert peer peer0.org2.aria.com.np org2
    peer_cert admin Admin@org2.aria.com.np org2

    infoln "Creating Orderer Org Identities"
    #function_name cert-type   CN   
    orderer_cert orderer orderer.aria.com.np
    orderer_cert admin Admin@aria.com.np
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.aria.com.np docker_peer0.org1.aria.com.np docker_peer0.org2.aria.com.np
